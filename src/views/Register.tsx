...
const Register: React.FC = () => {
  ...
  return (
    <div className="card max-w-md mx-auto mt-12 p-8 bg-gradient-to-br from-primary/5 to-secondary/5 shadow border border-primary/20 rounded-lg p-6 mb-6 transition-all hover:shadow-xl hover:-translate-y-1">
      <Seo
        ...
        path="/register"
      />
      <h1 className="text-3xl font-bold text-center mb-6">Opret bruger</h1>
      <form onSubmit={handleSubmit} className="grid gap-4" ref={formRef}>
        <fieldset className="fieldset gap-3">
          ...
          <input
            ...
            aria-invalid={firstNameTouched && firstNameInvalid}
          />
          ...
          <input
            ...
            pattern="^[A-Za-zÀ-ÿ' -]{2,}$"
            title="Mindst 2 bogstaver. Brug kun bogstaver, mellemrum, bindestreg eller apostrof."
            aria-invalid={lastNameTouched && lastNameInvalid}
          />
